...
public class DistanceAndDirectionCalculatorIn2DSpaceTest {

    @Test
    void twoPointsWithSameXAndYCoordinatesShouldHaveADistanceOfZero() {
        Point origin = new Point(0, 0);
        DistanceAndDirectionCalculator circleDistanceAndDirectionCalculator = new DistanceAndDirectionCalculatorIn2DSpace(origin,origin);
    ...
    void distanceBetweenOriginAndPointsOnUnitCircleShouldBeOne() {
        ...
        DistanceAndDirectionCalculator circleDistanceAndDirectionCalculator1 = new DistanceAndDirectionCalculatorIn2DSpace(origin,point1);
        DistanceAndDirectionCalculator circleDistanceAndDirectionCalculator2 = new DistanceAndDirectionCalculatorIn2DSpace(origin,point2);
    ...
    void distanceBetweenTwoOppositePointsOnUnitCircleShouldBeTwo() {
        ...
        DistanceAndDirectionCalculator circleDistanceAndDirectionCalculator = new DistanceAndDirectionCalculatorIn2DSpace(point1,point2);
